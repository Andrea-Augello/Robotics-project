...
\begin{document}
	...
	Abbiamo misurato le performance della stima di posizione e i risultati sono soddisfacenti per raggiungere l'obbiettivo proposto. In Fig. \ref{fig:dead_reckoning_error} sono mostrati i risultati delle misurazioni effettuate.
	...
	Al fine di migliorare la stima sulla distanza 
