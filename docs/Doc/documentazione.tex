...
\begin{document}
	...
	Per stimare lo spostamento, però, utilizziamo l'accelerometro
	...
	viene applicato un integrale doppio per ottenere lo spostamento
	lineare(Eq.~\ref{eq:accel-integration}).
	...
	associate aree molto più grandi. Per evitare questo problema, dopo avere
...
\tag{\ref{eq:circular_sector}}
	...
	che un oggeto più lontano occuperà una porzione più piccola dell'immagine,
