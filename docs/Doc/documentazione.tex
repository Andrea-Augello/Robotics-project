...
\begin{document}
	...
	La matrice di covarianza, mostrata in \ref{eq:covariance_matrix} mostra 
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\textwidth]{./img/error_covariance.pdf}
		\caption{Matrice di covarianza in 3 dimensioni}
		\label{fig:error_covariance}
	\end{figure}

	\begin{figure}[H]
		\centering
		\includegraphics[width=0.8\textwidth]{./img/error_covariance_flat.pdf}
		\caption{Matrice di covarianza in 2 dimensioni}
