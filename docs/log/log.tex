...
\begin{document}
	...
	I campi di potenziale \ldots~\cite{grisettiyz2005improving}
	...
	nulla, e decrese in modo monotono fino ad annullarsi se la distanza
	...
	moto anche se questo avviene parallelamente all'osctacolo. Per ovviare a
	questo problema prendiamo in considerazione solo gli ostacoli situati in un
	FOV frontale al robot con ampiezza calcolata per permettere di muoversi
	parallelamente ad una superficie mantenendo una distanza di sicurezza
	(Fig.~\ref{fig:obstacle_fov}.

	\begin{figure}[htpb]
		\centering
		\includegraphics[width=0.8\textwidth]{./img/obstacle_fov}
		\caption{\ldots}
