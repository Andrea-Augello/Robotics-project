...
\begin{document}
	...
	Dall'immagine binaria restituita in output da otsu estraiamo i contorni con un metodo fornito da OpenCV per utilizzare l'algoritmo in \ref{countours}.
