...
\title[Chang'e]{Documentazione - Progetto di Robotica}
	...
	Il modello Webots del \textbf{TIAGo} presenta un lidar, ovvero il modello Hokuyo URG-04LX-UG01 \cite{lidarspecs} che, come specificato dalla documentazione del modello Webots,  ha un range di $5.6\,m$ ed un FOV di $240^{\circ}$ (agli estremi è parzialmente occluso).}
	...
	\frame{
	Le bontà della stima della distanza e dell'angolo si evince dalle
	...
	\begin{figure}[H]
		...
		\end{subfigure}
		\caption{Distribuzione gaussiana multivariata con covarianza data nell'equazione~\ref{eq:covariance_matrix} }
\end{figure}}
