...
\tag{\ref{eq:circular_sector}}
	...
	\begin{frame}{Campi di potenziale}{Potenziale attrattivo}
	...
	\end{frame}
	\begin{frame}{Campi di potenziale}{Potenziale repulsivo}
	...
	\end{frame}
	\begin{frame}{Campi di potenziale}{Scelta dell'ostacolo}
