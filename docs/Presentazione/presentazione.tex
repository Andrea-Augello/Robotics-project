...
\title[Chang'e]{Documentazione - Progetto di Robotica}
	...
	\begin{itemize}
		\item Non presenta le "fat tails"
		\item Dopo una prima osservazione non confermata successivamente la probabilità scende a zero.
		\item Le occlusioni annullano la probabilità
		\item I target in movimento non verrebbero rilevati
	\end{itemize}
